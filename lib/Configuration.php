...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.liqu.id/v1';
    ...
    /**
     * User agent of the HTTP request, set to "PHP-Liquid" by default
     *
     * @var string
     */
    protected $userAgent = "PHP-Liquid/1.0.0";
    ...
    {
        $report  = "PHP SDK (Liquid\Client) Debug Report:\n";
        $report .= "    OS: ".php_uname()."\n";
        $report .= "    PHP Version: ".phpversion()."\n";
        $report .= "    Liquid Spec Version: 1\n";
